...
%introdução, colocar gráfico da arquitetura (mongo, graphdb, express(node))
...
%introdução, explicar de novo a arquitetura (servidor API vs interface(lado utilizador)), explicar footer e imagens usadas (onde estão armazenadas)
